...
namespace NonVisualComponents
{
    public partial class WordTableSecond : Component
    {
        ...
        public void SaveData<T>(WordTableConfig<T> config)
        {
        ...
        /// <summary>
        /// Метод создания таблицы. Принимает на вход WordTableConfig со всеми необходимыма параметрами, исходя
        /// из которых настраивает и создает таблицу.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="config"></param>

        private static Table CreateWordTable<T>(WordTableConfig<T> config)
        {
        ...
        public void CheckDataAndProperties<T>(WordTableConfig<T> config)
        {
